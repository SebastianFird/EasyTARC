...
from gui.window_main.page_main.tab_data.Tab_Data_CaseFrame_Manager import CaseFrameManagerTD
...
#################################################################
    ...
    def create_main_frame(self,container):
        ...
        self.case_frame = CaseFrameManagerTD(self.main_frame, self.main_app, self.gui, self.data_tab)
